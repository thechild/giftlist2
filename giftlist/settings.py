...
STATIC_URL = 'https://s3.amazonaws.com/cchild-giftlist/'
...
AWS_STORAGE_BUCKET_NAME = 'cchild-giftlist'
...
ROOT_URLCONF = 'giftlist.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'giftlist.wsgi.application'
